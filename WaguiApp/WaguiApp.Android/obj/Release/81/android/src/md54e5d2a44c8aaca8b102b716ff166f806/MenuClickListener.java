...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.Iconize.MenuClickListener, Plugin.Iconize", MenuClickListener.class, __md_methods);
	}
	...
	public MenuClickListener ()
	{
		...
		if (getClass () == MenuClickListener.class)
			mono.android.TypeManager.Activate ("Plugin.Iconize.MenuClickListener, Plugin.Iconize", "", this, new java.lang.Object[] {  });
	}
